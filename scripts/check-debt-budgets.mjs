...
const growthCaps = [
  ...
  ['src/app/commands/createBatchComposerCommands.ts', 90],
  ...
  ['src/processes/batch-runner/batchRunner.ts', 220],
  ['src/processes/batch-runner/batchTaskReducer.ts', 140],
  ['src/processes/batch-runner/batchRunProgress.ts', 90],
  ['src/processes/batch-runner/batchTaskModel.ts', 90],
