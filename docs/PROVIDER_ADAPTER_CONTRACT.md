...
Server routes should select an adapter through the registry and call the contract. They should not know OpenAI-compatible endpoint paths, multipart field names, probe fixtures, auth headers, or provider-specific retry/error rules.
